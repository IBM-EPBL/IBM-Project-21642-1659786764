...
public class ProductPricing extends javax.swing.JFrame implements KeyListener {
    ...
    private void initComponents() {
        ...
        jButton6.setToolTipText("Click this and view all product with their selling pricing");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if(!jComboBox1.getSelectedItem().toString().equals("")){
            try {
                ...
                connection.rs = connection.st.executeQuery("select *  from product_pricing where product_name in (select P_name from product where Category in('"+jComboBox1.getSelectedItem().toString()+"'))");
    ...
    public void keyPressed(KeyEvent ke) {
        ...
        if(KeyEvent.getKeyText(ke.getKeyCode()).equalsIgnoreCase("Enter")){
            ...
            try {
                connection.rs = connection.st.executeQuery("select * from product_pricing where product_name =(select p_name from product where barcode='"+barcode+"')");
                if(connection.rs.next()==false){
