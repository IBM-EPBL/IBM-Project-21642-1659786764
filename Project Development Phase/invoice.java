 ...
 * @author Abdul Rafay
 */
public class Invoice extends javax.swing.JFrame implements KeyListener,CaretListener{
    Connection con;
    public Invoice() throws ClassNotFoundException, SQLException{
        ...
        setLocationRelativeTo(null);
            String query1 = "Select * from supplies;";
            con.rs= con.st.executeQuery(query1);
            while (con.rs.next())
            {
                supplies.addItem(con.rs.getString("contact_person"));
            }
    ...
    private void initComponents() {
        ...
        supplies = new javax.swing.JComboBox<>();
        ...
        Search.setToolTipText("Enter barcode to view product");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(supplies, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JComboBox<String> supplies;
    ...
    public void keyPressed(KeyEvent e) throws NumberFormatException {
          try{
             ...
             if(KeyEvent.getKeyText(e.getKeyCode()).equals("Enter") && !Barcode.equals("")){
                ...
                con.rs = con.st.executeQuery("Select p_name from product where barcode="+Integer.parseInt(Barcode.getText()));
                if(!con.rs.next())
                    JOptionPane.showMessageDialog(null,"Unable to find data!!");
